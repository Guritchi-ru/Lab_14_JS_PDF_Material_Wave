(function() {
    ...
    downloadBtn.onclick = async () => {
        ...
        try {
            ...
            // Временно центрируем элемент для правильного захвата
            element.style.margin = '0 auto';
            element.style.padding = '20px';
            element.style.position = 'relative';
            element.style.top = '0';
            
            // ОПТИМАЛЬНЫЕ настройки PDF - без смещения
            const opt = {
                margin: [0.5, 0.5, 0.5, 0.5],  // Стандартные отступы
                filename: 'resume.pdf',
                ...
                html2canvas: { 
                    ...
                    onclone: (clonedDoc, element) => {
                        const clonedPage = clonedDoc.querySelector('.cv-page');
                        if (clonedPage) {
                            clonedPage.style.margin = '0 auto';
                            clonedPage.style.padding = '20px';
                        }
